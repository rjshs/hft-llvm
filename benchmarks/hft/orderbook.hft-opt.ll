...
7:                                                ; preds = %7, %3
  ...
  %prefetch.future.i = add i64 %8, 4
  %prefetch.idx.ptr = getelementptr i32, ptr %5, i64 %prefetch.future.i
  %prefetch.idx.val = load i32, ptr %prefetch.idx.ptr, align 4
  %prefetch.idx.ext = sext i32 %prefetch.idx.val to i64
  %prefetch.data.ptr = getelementptr %struct.LevelAnalytics, ptr %1, i64 %prefetch.idx.ext
  call void @llvm.prefetch.p0(ptr %prefetch.data.ptr, i32 0, i32 3, i32 1)
