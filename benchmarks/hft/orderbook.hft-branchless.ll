...
define dso_local void @_Z21updateSideAccumulator4Sided(i8 noundef zeroext %0, double noundef %1) local_unnamed_addr #7 {
  %3 = icmp eq i8 %0, 66
  %branchless.ptr = select i1 %3, ptr @g_accumulators, ptr getelementptr inbounds nuw (i8, ptr @g_accumulators, i64 8)
  %branchless.load = load double, ptr %branchless.ptr, align 8
  %branchless.fadd = fadd double %branchless.load, %1
  store double %branchless.fadd, ptr %branchless.ptr, align 8
  br label %4
...
39:                                               ; preds = %26
  call void @llvm.lifetime.start.p0(i64 794880, ptr nonnull %1) #20
  call void @_ZN17MarketDataHandlerC2Ev(ptr noundef nonnull align 64 dereferenceable(794880) %1)
  call void @llvm.lifetime.start.p0(i64 2504, ptr nonnull %2) #20
...
54:                                               ; preds = %50
  %55 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #20
...
60:                                               ; preds = %.loopexit, %54
  %61 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #20
...
74:                                               ; preds = %72
  ...
  br i1 %76, label %.loopexit, label %72, !llvm.loop !41
...
103:                                              ; preds = %100
  ...
  %108 = sub i64 %106, %107
  call void @_ZdlPvm(ptr noundef nonnull %101, i64 noundef %108) #21
  br label %109

109:                                              ; preds = %103, %100
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %3) #20
  call void @llvm.lifetime.end.p0(i64 2504, ptr nonnull %2) #20
  call void @llvm.lifetime.end.p0(i64 794880, ptr nonnull %1) #20
  ret i32 0

110:                                              ; preds = %98, %96, %94, %92, %90, %87, %85, %83, %81, %79, %60
...
57:                                               ; preds = %.loopexit3, %36
  %58 = phi ptr [ %38, %36 ], [ %285, %.loopexit3 ]
  %59 = phi ptr [ %37, %36 ], [ %286, %.loopexit3 ]
...
63:                                               ; preds = %57
  ...
  %68 = sub i64 %66, %67
  call void @_ZdlPvm(ptr noundef nonnull %61, i64 noundef %68) #21
  br label %69
...
72:                                               ; preds = %69
  ...
  %77 = sub i64 %75, %76
  call void @_ZdlPvm(ptr noundef nonnull %70, i64 noundef %77) #21
  br label %78
...
110:                                              ; preds = %94
  %111 = call double @nextafter(double noundef 1.000000e+00, double noundef 0.000000e+00) #20, !tbaa !8
  br label %112
...
112:                                              ; preds = %110, %94
  ...
  br i1 %120, label %.preheader2, label %134

.preheader2:                                      ; preds = %112
  br label %121

121:                                              ; preds = %.preheader2, %121
  %122 = phi i64 [ %132, %121 ], [ %119, %.preheader2 ]
  %123 = phi ptr [ %131, %121 ], [ %114, %.preheader2 ]
  %124 = lshr i64 %122, 1
  ...
  br i1 %133, label %121, label %.loopexit, !llvm.loop !66

.loopexit:                                        ; preds = %121
  br label %134

134:                                              ; preds = %.loopexit, %112
  %135 = phi ptr [ %114, %112 ], [ %131, %.loopexit ]
...
169:                                              ; preds = %153
  %170 = call double @nextafter(double noundef 1.000000e+00, double noundef 0.000000e+00) #20, !tbaa !8
  br label %171
...
176:                                              ; preds = %171
  ...
  br i1 %182, label %.preheader1, label %193

.preheader1:                                      ; preds = %176
  br label %183

183:                                              ; preds = %.preheader1, %185
...
279:                                              ; preds = %276
  ...
  %281 = sub i64 %280, %250
  call void @_ZdlPvm(ptr noundef nonnull %87, i64 noundef %281) #21
  br label %282
...
284:                                              ; preds = %282, %239
  ...
  br i1 %288, label %.loopexit3, label %83, !llvm.loop !71

289:                                              ; preds = %209, %207, %205, %203, %151, %149
  %290 = phi { ptr, i32 } [ %150, %149 ], [ %152, %151 ], [ %204, %203 ], [ %206, %205 ], [ %208, %207 ], [ %210, %209 ]
  call void @_ZNSt21discrete_distributionIiED2Ev(ptr noundef nonnull align 8 dereferenceable(48) %4) #20
  br label %291
...
297:                                              ; preds = %293
  ...
  %302 = sub i64 %300, %301
  call void @_ZdlPvm(ptr noundef nonnull %295, i64 noundef %302) #21
  br label %303
...
22:                                               ; preds = %.preheader, %22
  %23 = phi i64 [ %26, %22 ], [ %20, %.preheader ]
  %24 = cmpxchg weak ptr %19, i64 %23, i64 %16 seq_cst seq_cst, align 8
  %25 = extractvalue { i64, i1 } %24, 1
  %26 = extractvalue { i64, i1 } %24, 0
  %27 = icmp ule i64 %16, %26
  %28 = select i1 %25, i1 true, i1 %27
  br i1 %28, label %.loopexit1, label %22, !llvm.loop !73

.loopexit1:                                       ; preds = %22
  br label %29

29:                                               ; preds = %.loopexit1, %15, %2
...
96:                                               ; preds = %96, %93
  ...
  br i1 %100, label %.loopexit, label %96, !llvm.loop !54
...
107:                                              ; preds = %.loopexit, %104, %84, %82, %54, %49, %33
...
define linkonce_odr dso_local noundef i64 @_ZNSt23mersenne_twister_engineImLm64ELm312ELm156ELm31ELm13043109905998158313ELm29ELm6148914691236517205ELm17ELm8202884508482404352ELm37ELm18444473444759240704ELm43ELm6364136223846793005EEclEv(ptr noundef nonnull align 8 dereferenceable(2504) %0) local_unnamed_addr #5 comdat align 2 {
  ...
  br i1 %4, label %.preheader1, label %60

.preheader1:                                      ; preds = %1
  br label %5

5:                                                ; preds = %.preheader1, %5
  %6 = phi i64 [ %10, %5 ], [ 0, %.preheader1 ]
  ...
  br i1 %24, label %.preheader, label %5, !llvm.loop !76

.preheader:                                       ; preds = %5
  br label %25

25:                                               ; preds = %.preheader, %25
  %26 = phi i64 [ %30, %25 ], [ 156, %.preheader ]
...
5:                                                ; preds = %1
  ...
  %10 = sub i64 %8, %9
  tail call void @_ZdlPvm(ptr noundef nonnull %3, i64 noundef %10) #21
  br label %11
...
6:                                                ; preds = %3
  %7 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %4) #23
...
13:                                               ; preds = %1
  br i1 %10, label %21, label %.preheader1

.preheader1:                                      ; preds = %13
  br label %14

14:                                               ; preds = %.preheader1, %14
  %15 = phi double [ %18, %14 ], [ 0.000000e+00, %.preheader1 ]
  %16 = phi ptr [ %19, %14 ], [ %4, %.preheader1 ]
  %17 = load double, ptr %16, align 8, !tbaa !65
  %18 = fadd double %15, %17
  %19 = getelementptr inbounds nuw i8, ptr %16, i64 8
  %20 = icmp eq ptr %19, %3
  br i1 %20, label %.loopexit2, label %14, !llvm.loop !79

.loopexit2:                                       ; preds = %14
  br label %21

21:                                               ; preds = %.loopexit2, %13
  %22 = phi double [ 0.000000e+00, %13 ], [ %18, %.loopexit2 ]
...
41:                                               ; preds = %33
  ...
  %45 = sub i64 %44, %38
  %46 = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %7) #23
...
37:                                               ; preds = %34
  ...
  %39 = sub i64 %38, %17
  tail call void @_ZdlPvm(ptr noundef nonnull %15, i64 noundef %39) #21
  br label %40
...
42:                                               ; preds = %40, %12
  ...
  %44 = icmp eq ptr %43, %1
  br i1 %44, label %86, label %.preheader

.preheader:                                       ; preds = %42
  br label %45

45:                                               ; preds = %.preheader, %83
  %46 = phi ptr [ %84, %83 ], [ %43, %.preheader ]
  %47 = phi double [ %49, %83 ], [ %6, %.preheader ]
...
83:                                               ; preds = %81, %53
  ...
  %85 = icmp eq ptr %84, %1
  br i1 %85, label %.loopexit, label %45, !llvm.loop !81

.loopexit:                                        ; preds = %83
  br label %86

86:                                               ; preds = %.loopexit, %42, %3
  ret ptr %2
}
...
24:                                               ; preds = %31, %19
  ...
  br i1 %29, label %.loopexit1, label %31
...
31:                                               ; preds = %24
  ...
  br i1 %38, label %.loopexit2, label %24, !llvm.loop !86

.loopexit2:                                       ; preds = %31
  br label %39

39:                                               ; preds = %.loopexit2, %2
  %40 = phi i32 [ 0, %2 ], [ %36, %.loopexit2 ]
...
53:                                               ; preds = %53, %44
  ...
  br i1 %58, label %53, label %.loopexit, !llvm.loop !88

.loopexit1:                                       ; preds = %24
  br label %59

59:                                               ; preds = %.loopexit1, %48, %39
  %60 = phi i32 [ %40, %48 ], [ -1, %39 ], [ %30, %.loopexit1 ]
...
28:                                               ; preds = %35, %23
  ...
  br i1 %33, label %.loopexit1, label %35
...
35:                                               ; preds = %28
  ...
  br i1 %42, label %.loopexit2, label %28, !llvm.loop !86

.loopexit2:                                       ; preds = %35
  br label %43

43:                                               ; preds = %.loopexit2, %13
  %44 = phi i32 [ 0, %13 ], [ %40, %.loopexit2 ]
...
57:                                               ; preds = %57, %48
  ...
  br i1 %62, label %57, label %.loopexit, !llvm.loop !88

.loopexit1:                                       ; preds = %28
  br label %63

63:                                               ; preds = %.loopexit1, %52, %43
  %64 = phi i32 [ %44, %52 ], [ -1, %43 ], [ %34, %.loopexit1 ]
...
16:                                               ; preds = %11
  ...
  br i1 %18, label %.loopexit3, label %11, !llvm.loop !91
...
21:                                               ; preds = %.loopexit3, %19, %4
  %22 = phi i32 [ -1, %4 ], [ %20, %19 ], [ -1, %.loopexit3 ]
...
54:                                               ; preds = %54, %51
  ...
  br i1 %59, label %.loopexit1, label %54, !llvm.loop !93

60:                                               ; preds = %33
  %61 = add nuw nsw i64 %34, 1
  %62 = icmp eq i64 %61, %32
  br i1 %62, label %.loopexit2, label %33, !llvm.loop !94

.loopexit2:                                       ; preds = %60
  br label %63

63:                                               ; preds = %.loopexit2, %53, %38, %24
  %64 = phi i1 [ true, %38 ], [ true, %53 ], [ false, %24 ], [ false, %.loopexit2 ]
...
73:                                               ; preds = %73, %70
  ...
  br i1 %78, label %.loopexit, label %73, !llvm.loop !95

.loopexit:                                        ; preds = %73
  br label %79

79:                                               ; preds = %.loopexit, %67
