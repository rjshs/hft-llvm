...
53:                                               ; preds = %51
  ...
  br i1 %55, label %.loopexit, label %51, !llvm.loop !17
...
121:                                              ; preds = %.preheader2, %121
  ...
  br i1 %133, label %121, label %.loopexit, !llvm.loop !45
...
284:                                              ; preds = %282, %239
  ...
  br i1 %288, label %.loopexit3, label %83, !llvm.loop !53
...
22:                                               ; preds = %.preheader, %22
  ...
  br i1 %28, label %.loopexit1, label %22, !llvm.loop !57

.loopexit1:                                       ; preds = %22
  br label %29

29:                                               ; preds = %.loopexit1, %15, %2
  %30 = load i8, ptr %1, align 1, !tbaa !58
...
36:                                               ; preds = %29
  ...
  %43 = load i64, ptr %42, align 1, !tbaa !60
  %44 = getelementptr inbounds nuw i8, ptr %1, i64 4
  %45 = load i64, ptr %44, align 1, !tbaa !61
  %46 = getelementptr inbounds nuw i8, ptr %1, i64 20
  %47 = load i32, ptr %46, align 1, !tbaa !62
...
57:                                               ; preds = %29
  ...
  %64 = load i64, ptr %63, align 1, !tbaa !60
  %65 = getelementptr inbounds nuw i8, ptr %1, i64 4
  %66 = load i64, ptr %65, align 1, !tbaa !61
  %67 = getelementptr inbounds nuw i8, ptr %1, i64 20
  %68 = load i32, ptr %67, align 1, !tbaa !62
...
70:                                               ; preds = %57
  ...
  %74 = load i32, ptr %67, align 1, !tbaa !62
  %75 = sext i32 %74 to i64
  %76 = atomicrmw add ptr %73, i64 %75 seq_cst, align 8
  %77 = load i8, ptr %58, align 1, !tbaa !59
  %78 = icmp eq i8 %77, 66
  %79 = getelementptr inbounds nuw i8, ptr %0, i64 794760
  %80 = load i32, ptr %67, align 1, !tbaa !62
...
88:                                               ; preds = %88, %86
  ...
  br i1 %92, label %93, label %88, !llvm.loop !31
...
96:                                               ; preds = %96, %93
  ...
  br i1 %100, label %.loopexit, label %96, !llvm.loop !31

101:                                              ; preds = %29
  %102 = getelementptr inbounds nuw i8, ptr %0, i64 794728
  br label %127

103:                                              ; preds = %57, %52, %36, %31
  %104 = getelementptr inbounds nuw i8, ptr %0, i64 794744
  %105 = atomicrmw add ptr %104, i64 1 seq_cst, align 8
  br label %106

.loopexit:                                        ; preds = %96
  br label %106

106:                                              ; preds = %.loopexit, %103, %84, %82, %54, %49, %33
  ...
  %113 = getelementptr inbounds nuw i8, ptr %0, i64 397324
  %114 = load i32, ptr %113, align 4, !tbaa !26
  %115 = icmp eq i32 %114, 0
  %116 = getelementptr inbounds nuw i8, ptr %0, i64 397328
  %117 = load i64, ptr %116, align 16
  %118 = select i1 %115, i64 0, i64 %117
  %119 = getelementptr inbounds nuw i8, ptr %0, i64 794808
  store atomic i64 %112, ptr %119 seq_cst, align 8
  %120 = getelementptr inbounds nuw i8, ptr %0, i64 794816
  store atomic i64 %118, ptr %120 seq_cst, align 64
...
124:                                              ; preds = %106
  %125 = getelementptr inbounds nuw i8, ptr %0, i64 794824
  %126 = sub nsw i64 %118, %112
  store atomic i64 %126, ptr %125 seq_cst, align 8
  br label %127

127:                                              ; preds = %124, %106, %101
  %128 = phi ptr [ %102, %101 ], [ %3, %106 ], [ %3, %124 ]
...
5:                                                ; preds = %.preheader1, %5
  ...
  br i1 %24, label %.preheader, label %5, !llvm.loop !63
...
14:                                               ; preds = %.preheader1, %14
  ...
  %20 = icmp eq ptr %19, %3
  br i1 %20, label %.loopexit2, label %14, !llvm.loop !66
...
23:                                               ; preds = %.preheader, %23
  ...
  %28 = icmp eq ptr %27, %3
  br i1 %28, label %.loopexit, label %23, !llvm.loop !67
...
83:                                               ; preds = %81, %53
  ...
  %85 = icmp eq ptr %84, %1
  br i1 %85, label %.loopexit, label %45, !llvm.loop !68
...
31:                                               ; preds = %24
  ...
  br i1 %38, label %.loopexit2, label %24, !llvm.loop !73
...
53:                                               ; preds = %53, %44
  ...
  br i1 %58, label %53, label %.loopexit, !llvm.loop !75
...
35:                                               ; preds = %28
  ...
  br i1 %42, label %.loopexit2, label %28, !llvm.loop !73
...
57:                                               ; preds = %57, %48
  ...
  br i1 %62, label %57, label %.loopexit, !llvm.loop !75
...
16:                                               ; preds = %11
  ...
  br i1 %18, label %.loopexit3, label %11, !llvm.loop !78
...
54:                                               ; preds = %54, %51
  ...
  br i1 %59, label %.loopexit1, label %54, !llvm.loop !80

60:                                               ; preds = %33
  %61 = add nuw nsw i64 %34, 1
  %62 = icmp eq i64 %61, %32
  br i1 %62, label %.loopexit2, label %33, !llvm.loop !81
...
73:                                               ; preds = %73, %70
  ...
  br i1 %78, label %.loopexit, label %73, !llvm.loop !82
