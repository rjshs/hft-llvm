...
define dso_local noundef i32 @main() local_unnamed_addr #5 personality ptr @__gxx_personality_v0 {
  ...
  call void @llvm.lifetime.start.p0(i64 794880, ptr nonnull %1) #17
  call void @_ZN17MarketDataHandlerC2Ev(ptr noundef nonnull align 64 dereferenceable(794880) %1)
  call void @llvm.lifetime.start.p0(i64 2504, ptr nonnull %2) #17
...
33:                                               ; preds = %29
  %34 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #17
...
39:                                               ; preds = %53, %33
  %40 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #17
...
82:                                               ; preds = %79
  ...
  %87 = sub i64 %85, %86
  call void @_ZdlPvm(ptr noundef nonnull %80, i64 noundef %87) #18
  br label %88

88:                                               ; preds = %79, %82
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %3) #17
  call void @llvm.lifetime.end.p0(i64 2504, ptr nonnull %2) #17
  call void @llvm.lifetime.end.p0(i64 794880, ptr nonnull %1) #17
  ret i32 0

89:                                               ; preds = %75, %73, %71, %69, %66, %64, %62, %60, %58, %39, %77
...
95:                                               ; preds = %91
  ...
  %100 = sub i64 %98, %99
  call void @_ZdlPvm(ptr noundef nonnull %93, i64 noundef %100) #18
  br label %101
...
63:                                               ; preds = %57
  ...
  %68 = sub i64 %66, %67
  call void @_ZdlPvm(ptr noundef nonnull %61, i64 noundef %68) #18
  br label %69
...
72:                                               ; preds = %69
  ...
  %77 = sub i64 %75, %76
  call void @_ZdlPvm(ptr noundef nonnull %70, i64 noundef %77) #18
  br label %78
...
110:                                              ; preds = %94
  %111 = call double @nextafter(double noundef 1.000000e+00, double noundef 0.000000e+00) #17, !tbaa !42
  br label %112
...
169:                                              ; preds = %153
  %170 = call double @nextafter(double noundef 1.000000e+00, double noundef 0.000000e+00) #17, !tbaa !42
  br label %171
...
255:                                              ; preds = %248
  ...
  %264 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %263) #20
...
279:                                              ; preds = %276
  ...
  %281 = sub i64 %280, %250
  call void @_ZdlPvm(ptr noundef nonnull %87, i64 noundef %281) #18
  br label %282
...
289:                                              ; preds = %203, %207, %209, %205, %149, %151
  ...
  call void @_ZNSt21discrete_distributionIiED2Ev(ptr noundef nonnull align 8 dereferenceable(48) %4) #17
  br label %291
...
297:                                              ; preds = %293
  ...
  %302 = sub i64 %300, %301
  call void @_ZdlPvm(ptr noundef nonnull %295, i64 noundef %302) #18
  br label %303
...
22:                                               ; preds = %15, %22
  ...
  br i1 %28, label %29, label %22, !llvm.loop !57
...
5:                                                ; preds = %1
  ...
  %10 = sub i64 %8, %9
  tail call void @_ZdlPvm(ptr noundef nonnull %3, i64 noundef %10) #18
  br label %11
...
14:                                               ; preds = %11
  ...
  %19 = sub i64 %17, %18
  tail call void @_ZdlPvm(ptr noundef nonnull %12, i64 noundef %19) #18
  br label %20
...
6:                                                ; preds = %3
  %7 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %4) #20
...
27:                                               ; preds = %23
  ...
  %32 = sub i64 %30, %31
  tail call void @_ZdlPvm(ptr noundef nonnull %25, i64 noundef %32) #18
  br label %33
...
41:                                               ; preds = %33
  ...
  %45 = sub i64 %44, %38
  %46 = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %7) #20
...
37:                                               ; preds = %34
  ...
  %39 = sub i64 %38, %17
  tail call void @_ZdlPvm(ptr noundef nonnull %15, i64 noundef %39) #18
  br label %40
